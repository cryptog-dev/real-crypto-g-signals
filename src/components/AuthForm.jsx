          ...
          >
            ...
            <div className="space-y-5">
              ...
              <div className="flex items-center my-5">
                ...
                <span className="mx-3 text-xs text-contrast-medium font-sans">
                  or
                </span>
                <div className="flex-1 h-px bg-[var(--color-border-light)]" />
              </div>
                  ...
                  {googleLoading ? (
                    ...
                    <>
                      ...
                      >
                        <path
                          fill="#FFC107"
                          d="M43.611 20.083H42V20H24v8h11.303c-1.649 4.657-6.08 8-11.303 8-6.627 0-12-5.373-12-12s5.373-12 12-12c3.059 0 5.842 1.154 7.961 3.039l5.657-5.657C33.64 6.053 29.083 4 24 4 12.955 4 4 12.955 4 24s8.955 20 20 20 20-8.955 20-20c0-1.341-.138-2.651-.389-3.917z"
                        />
                        <path
                          fill="#FF3D00"
                          d="M6.306 14.691l6.571 4.817C14.655 16.108 18.961 13 24 13c3.059 0 5.842 1.154 7.961 3.039l5.657-5.657C33.64 6.053 29.083 4 24 4 16.318 4 9.656 8.337 6.306 14.691z"
                        />
                        <path
                          fill="#4CAF50"
                          d="M24 44c5.176 0 9.86-1.977 13.409-5.197l-6.19-5.238C29.139 35.091 26.715 36 24 36c-5.202 0-9.62-3.317-11.283-7.946l-6.533 5.032C9.5 39.556 16.227 44 24 44z"
                        />
                        <path
                          fill="#1976D2"
                          d="M43.611 20.083H42V20H24v8h11.303c-.793 2.237-2.231 4.166-4.084 5.565l.003-.002 6.19 5.238C39.011 36.798 44 31.5 44 24c0-1.341-.138-2.651-.389-3.917z"
                        />
                      </svg>
                      <span>
                        {isLogin
